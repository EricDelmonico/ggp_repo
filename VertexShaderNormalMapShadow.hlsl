...
// --------------------------------------------------------
VertexToPixel_NormalMapShadowMap main(VertexShaderInput input)
{
	// Set up output struct
	VertexToPixel_NormalMapShadowMap output;
	...
	// Pass the normal and tangent through--need to transform appropriately
